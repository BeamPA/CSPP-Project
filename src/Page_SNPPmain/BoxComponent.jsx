  ...
  return (
    ...
    <div
      className={`relative flex-shrink-0 w-[160px] h-[151px] rounded-2xl ${
        isInteractive && isHovered ? "border-4 border-yellow-400" : "border-transparent"
        }`}
    ...
    >
      ...
      <div
        className={`absolute top-3 left-4 w-[125px] h-[120px] rounded-2xl z-20 flex flex-col items-center justify-center text-center ${isInteractive
          ...
          <div className="absolute bottom-2 flex justify-between w-full px-2">
            ...
            <button
              className={`w-[48px] h-[33px] rounded-2xl z-30 text-black ${
                ...
                onClick={() => toggleStartStop(label)} // ✅ แค่เรียก toggleStartStop
